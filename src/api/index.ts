export * as authControllers from "@/api/v1/authentication";
export * as departmentsControllers from "@/api/v1/departments";
export * as employeeControllers from "@/api/v1/employees";
